...
func (s *candidates) Create(ctx context.Context, request operations.CandidatesCreateRequest, security operations.CandidatesCreateSecurity) (*operations.CandidatesCreateResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "CandidateEndpointRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
...
func (s *candidates) IgnoreCreate(ctx context.Context, request operations.CandidatesIgnoreCreateMultipartRequest, security operations.CandidatesIgnoreCreateMultipartSecurity) (*operations.CandidatesIgnoreCreateMultipartResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "IgnoreCommonModelRequest2", "multipart")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.CandidatesIgnoreCreateMultipartResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// IgnoreCreate - Ignores a specific row based on the `model_id` in the url. These records will have their properties set to null, and will not be updated in future syncs. The "reason" and "message" fields in the request body will be stored for audit purposes.
func (s *candidates) IgnoreCreate(ctx context.Context, request operations.CandidatesIgnoreCreateFormRequest, security operations.CandidatesIgnoreCreateFormSecurity) (*operations.CandidatesIgnoreCreateFormResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/candidates/ignore/{model_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "IgnoreCommonModelRequest2", "form")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.CandidatesIgnoreCreateFormResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
// IgnoreCreate - Ignores a specific row based on the `model_id` in the url. These records will have their properties set to null, and will not be updated in future syncs. The "reason" and "message" fields in the request body will be stored for audit purposes.
func (s *candidates) IgnoreCreate(ctx context.Context, request operations.CandidatesIgnoreCreateJSONRequest, security operations.CandidatesIgnoreCreateJSONSecurity) (*operations.CandidatesIgnoreCreateJSONResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url, err := utils.GenerateURL(ctx, baseURL, "/candidates/ignore/{model_id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "IgnoreCommonModelRequest", "json")
	if err != nil {
		return nil, fmt.Errorf("error serializing request body: %w", err)
	}
	if bodyReader == nil {
	...
	res := &operations.CandidatesIgnoreCreateJSONResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
...
func (s *candidates) List(ctx context.Context, request operations.CandidatesListRequest, security operations.CandidatesListSecurity) (*operations.CandidatesListResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/candidates"
