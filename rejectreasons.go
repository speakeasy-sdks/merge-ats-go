...
func (s *rejectReasons) List(ctx context.Context, request operations.RejectReasonsListRequest, security operations.RejectReasonsListSecurity) (*operations.RejectReasonsListResponse, error) {
