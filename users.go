...
func (s *users) List(ctx context.Context, request operations.UsersListRequest, security operations.UsersListSecurity) (*operations.UsersListResponse, error) {
...
func (s *users) Retrieve(ctx context.Context, request operations.UsersRetrieveRequest, security operations.UsersRetrieveSecurity) (*operations.UsersRetrieveResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
