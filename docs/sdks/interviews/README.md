...
func main() {
    ...
    scheduledInterviewEndpointRequest := shared.ScheduledInterviewEndpointRequest{
        Model: shared.ScheduledInterviewRequest{
            ...
            Interviewers: []string{
                "178e4796-f2a7-40c6-8828-2aa482562f22",
            },
...
func main() {
    ...
    res, err := s.Interviews.List(ctx, operations.InterviewsListRequest{
        XAccountToken: "et",
        ApplicationID: mergeatsgo.String("esse"),
        CreatedAfter: types.MustTimeFromString("2020-05-10T03:57:05.694Z"),
        CreatedBefore: types.MustTimeFromString("2022-07-17T14:37:45.086Z"),
        Cursor: mergeatsgo.String("quod"),
        Expand: operations.InterviewsListExpandJobInterviewStage.ToPointer(),
        IncludeDeletedData: mergeatsgo.Bool(false),
        IncludeRemoteData: mergeatsgo.Bool(false),
        JobInterviewStageID: mergeatsgo.String("vero"),
        ModifiedAfter: types.MustTimeFromString("2022-11-27T21:17:41.726Z"),
        ModifiedBefore: types.MustTimeFromString("2021-09-21T04:40:52.923Z"),
        OrganizerID: mergeatsgo.String("harum"),
        PageSize: mergeatsgo.Int64(473221),
        RemoteFields: mergeatsgo.String("rerum"),
        RemoteID: mergeatsgo.String("occaecati"),
        ShowEnumOrigins: mergeatsgo.String("minima"),
    })
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Interviews.Retrieve(ctx, operations.InterviewsRetrieveRequest{
        ...
        Expand: operations.InterviewsRetrieveExpandOrganizer.ToPointer(),
        ID: "0ab3c20c-4f37-489f-9871-f99dd2efd121",
        IncludeRemoteData: mergeatsgo.Bool(false),
        RemoteFields: mergeatsgo.String("similique"),
        ShowEnumOrigins: mergeatsgo.String("culpa"),
    })
    if err != nil {
        log.Fatal(err)
    }
