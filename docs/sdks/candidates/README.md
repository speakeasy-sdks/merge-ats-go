...
func main() {
    ...
    res, err := s.Candidates.IgnoreCreate(ctx, operations.CandidatesIgnoreCreateRequest{
        ...
        XAccountToken: "in",
        ModelID: "44ed53b8-8f3a-48d8-b5c0-b2f2fb7b194a",
    }, operationSecurity)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Candidates.List(ctx, operations.CandidatesListRequest{
        XAccountToken: "sed",
        CreatedAfter: types.MustTimeFromString("2022-08-01T14:49:09.199Z"),
        CreatedBefore: types.MustTimeFromString("2022-09-27T03:48:38.490Z"),
        Cursor: ats.String("voluptas"),
        EmailAddresses: ats.String("unde"),
        Expand: operations.CandidatesListExpandApplications.ToPointer(),
        FirstName: ats.String("Geovany"),
        IncludeDeletedData: ats.Bool(false),
        IncludeRemoteData: ats.Bool(false),
        LastName: ats.String("Willms"),
        ModifiedAfter: types.MustTimeFromString("2022-10-13T16:25:20.976Z"),
        ModifiedBefore: types.MustTimeFromString("2022-12-10T20:46:47.432Z"),
        PageSize: ats.Int64(546885),
        RemoteID: ats.String("maiores"),
        Tags: ats.String("incidunt"),
    }, operationSecurity)
    if err != nil {
        log.Fatal(err)
    }
