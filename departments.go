...
func (s *departments) List(ctx context.Context, request operations.DepartmentsListRequest, security operations.DepartmentsListSecurity) (*operations.DepartmentsListResponse, error) {
