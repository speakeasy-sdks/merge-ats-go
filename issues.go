...
// List - Gets issues.
func (s *issues) List(ctx context.Context, request operations.IssuesListRequest, security operations.IssuesListSecurity) (*operations.IssuesListResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.PaginatedIssueList
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out); err != nil {
				return nil, err
			}

			res.PaginatedIssueList = out
		default:
...
func (s *issues) Retrieve(ctx context.Context, request operations.IssuesRetrieveRequest, security operations.IssuesRetrieveSecurity) (*operations.IssuesRetrieveResponse, error) {
	...
	res := &operations.IssuesRetrieveResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: contentType,
		RawResponse: httpRes,
	}
