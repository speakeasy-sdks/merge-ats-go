...
func (s *activities) Create(ctx context.Context, request operations.ActivitiesCreateRequest, security operations.ActivitiesCreateSecurity) (*operations.ActivitiesCreateResponse, error) {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, "ActivityEndpointRequest", "json")
	if err != nil {
...
func (s *activities) List(ctx context.Context, request operations.ActivitiesListRequest, security operations.ActivitiesListSecurity) (*operations.ActivitiesListResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
	url := strings.TrimSuffix(baseURL, "/") + "/activities"
...
func (s *activities) Retrieve(ctx context.Context, request operations.ActivitiesRetrieveRequest, security operations.ActivitiesRetrieveSecurity) (*operations.ActivitiesRetrieveResponse, error) {
	baseURL := utils.ReplaceParameters(s.sdkConfiguration.GetServerDetails())
